# INTEGRASYON_TODO — Arşiv (2026-07-22 → 2026-07-31, kapanmış içerik)

Bu dosya `INTEGRASYON_TODO.md`'den 2026-08-10'da taşındı (context/token tasarrufu — ana dosya
tek başına ~111K token'a çıkmıştı, her session'da otomatik yükleniyordu). **Hiçbir içerik
silinmedi/kısaltılmadı, aynen buraya taşındı.** Bu, tarih aralığındaki (2026-07-22 → 2026-07-31)
kapanmış madde/oturum kayıtlarının BİREBİR halidir — güncel açık iş için ana dosyaya
(`INTEGRASYON_TODO.md`) bak, bu dosyayı normal bir oturumda okumana gerek yok; sadece eski bir
kararın/hatanın/metnin tam halini ararken `grep` ile buraya bak.
